...
location_tables: Dict[str, List[SekiroLocationData]] = {
    "Ashina Reservoir - Tutorial": [
        ...
        SekiroLocationData("AR1: Ornamental Letter - in starting well", "Ornamental Letter", static='01,0:51120000::',
                           missable=True),
        SekiroLocationData("AR1: Pellet - AR gate, miniboss drop", "Pellet", static='01,0:51112920::', missable=True),
    ...
    "Dilapidated Temple": [
        ...
        SekiroLocationData("DT: Gourd Seed - Fujioka the Info Broker", "Gourd Seed", static='00,0:-1:1100400:',
                           npc=True, shop=True, conditional=True),
        ...
        SekiroLocationData("DT: Three-story Pagoda Memo - Fujioka the Info Broker", "Three-story Pagoda Memo",
                           static='00,0:-1:1100400:', npc=True, shop=True, conditional=True),
        SekiroLocationData("DT: Valley Apparitions Memo - Fujioka after boss killed in Guardian Ape's Burrow",
                           "Valley Apparitions Memo", static='00,0:-1:8307,1100400:', npc=True, shop=True,
                           conditional=True),
    ],
    "Ashina Outskirts": [
        ...
        SekiroLocationData("AO1: Black Gunpowder - right cobblestone platform, enemy drop", "Black Gunpowder",
                           static='00,0:51100940::', drop=True),
        ...
        SekiroLocationData("AO1: Herb Catalogue Scrap - near Ashina Castle Fortress idol, enemy drop",
                           "Herb Catalogue Scrap", static='00,0:51100930::', drop=True),
        ...
        # Do not generate this for now as it is highly missable and access rules are funky.
        ...
        SekiroLocationData("AO1: Phantom Kunai - Anayama the Peddler", "Phantom Kunai",
                           static='00,0:-1:9026,1100200,1100500:', npc=True, shop=True, offering_box=True),
        ...
        SekiroLocationData("AO1: Robert's Firecrackers - Crow's Bed & Battlefield Memorial Mob",
                           "Robert's Firecrackers", static='00,0:-1:1100000,1100100:', npc=True, shop=True),
    ...
    "Hirata Estate - Young Lord's Bell Charm": [
        ...
        SekiroLocationData("HE1: Bulging Coin Purse - side path before cave, enemy drop", "Bulging Coin Purse",
                           static='03,0:51000930::', drop=True, conditional=True),
        ...
        SekiroLocationData("HE1: Divine Grass - Pot Noble Harunaga", "Divine Grass",
                           static='03,0:-1:1622,1000000,2500000:', npc=True, shop=True),
        ...
        SekiroLocationData("HE1: Floating Passage Text - Pot Noble Harunaga", "Floating Passage Text",
                           static='03,0:-1:1622,1000000,2500000:', npc=True, shop=True, conditional=True),
        ...
        # Do not generate as we cannot guarantee which Bait is used
        ...
        SekiroLocationData("HE1: Scrap Iron - guarding three-storey pagoda, enemy drop", "Scrap Iron",
                           static='03,0:51000940::', drop=True, conditional=True),
        ...
        SekiroLocationData("HE1: Truly Precious Bait - Pot Noble Harunaga after trading 6 scales",
                           "Truly Precious Bait (Harunaga)", static='03,0:50006360::', missable=True,
                           npc=True, conditional=True),
    ...
    "Ashina Castle": [
        ...
        SekiroLocationData("AC1: Anti-air Deathblow Text - Blackhat Badger", "Anti-air Deathblow Text",
                           static='02,0:-1:9020,1100500,1111400:', npc=True, shop=True, offering_box=True),
        ...
        SekiroLocationData("AC1: Iron Fortress - Blackhat Badger", "Iron Fortress",
                           static='02,0:6506:9034,1100500,1111400:', npc=True, shop=True, offering_box=True),
        ...
        SekiroLocationData("AC1: Scrap Magnetite - before Bull arena, enemy drop", "Scrap Magnetite",
                           static='02,0:51110972::', drop=True),
        ...
        SekiroLocationData("AC1: Shinobi Medicine Rank 2 - Ashina Castle Gate, miniboss drop",
                           "Shinobi Medicine Rank 2", static='02,0:6711::', missable=True, miniboss=True),
        ...
        SekiroLocationData("AC1: Ungo's Spiritfall - underwater, headless drop", "Ungo's Spiritfall",
                           static='02,0:51110973::', conditional=True, headless=True, diving=True),
    ...
    "Ashina Reservoir - Revisit": [
        ...
        SekiroLocationData("AR2: Gatehouse Key - bridge leading to ADG, enemy drop", "Gatehouse Key",
                           static='02,0:51110984::', drop=True),
    ...
    "Abandoned Dungeon": [
        ...
        SekiroLocationData("ADG: Mask Fragment: Dragon - Dungeon Memorial Mob", "Mask Fragment: Dragon",
                           static='02,0:-1:1110000:', npc=True, shop=True),
    ...
    "Senpou Temple, Mt. Kongo": [
        ...
        SekiroLocationData("ST: Bulging Coin Purse - kill 3 enemies outside Main Hall", "Bulging Coin Purse",
                           static='07,0:52000910::', drop=True),
        ...
        SekiroLocationData("ST: Holy Chapter: Infested - underwater, Carp pond", "Holy Chapter: Infested",
                           static='07,0:50006320::', npc=True, conditional=True, diving=True),
        ...
        SekiroLocationData("ST: Scrap Magnetite - on slope leading to Main Hall, enemy drop", "Scrap Magnetite",
                           static='07,0:52000930::', drop=True),
        ...
        SekiroLocationData("ST: Yellow Gunpowder - cliffside temple, miniboss drop", "Yellow Gunpowder x2",
                           static='07,0:52000941::', missable=True),
    ],
    "Sunken Valley": [
        ...
        SekiroLocationData("SV: Gokan's Spiritfall - pond cave, miniboss drop", "Gokan's Spiritfall",
                           static='06,0:51700990::', conditional=True, headless=True, diving=True),
        ...
        SekiroLocationData("SV: Yellow Gunpowder - Gun Fort shrine, miniboss drop", "Yellow Gunpowder x2",
                           static='06,0:51700961::', missable=True),
    ...
    "Sunken Valley Passage": [
        ...
        SekiroLocationData("SVP: Fresh Serpent Viscera - Sunken Valley Cavern, plunge kill serpent",
                           "Fresh Serpent Viscera", static='06,0:51700940::', progression=True, drop=True,
                           conditional=True),
        ...
        SekiroLocationData("SVP: Green Mossy Gourd - Toxic Memorial Mob", "Green Mossy Gourd",
                           static='06,0:-1:1700000:', npc=True, shop=True),
        ...
        SekiroLocationData("SVP: Monkey Booze - kill 23-enemy cluster between statues", "Monkey Booze",
                           static='06,0:51700670::', drop=True),
    ...
    "Poison Pool": [
        SekiroLocationData("PP: Bestowal Ninjutsu - Guardian Ape's Burrow, boss drop", "Bestowal Ninjutsu",
                           static='06,0:6747::', boss=True, drop=True, conditional=True),
        ...
        SekiroLocationData("PP: Memory: Headless Ape - Guardian Ape's Burrow, boss drop", "Memory: Headless Ape",
                           static='06,0:50002017::', prominent=True, boss=True, conditional=True),
    ...
    "Hidden Forest": [
        ...
        SekiroLocationData("HF: Gachiin's Spiritfall - sinkhole, miniboss drop", "Gachiin's Spiritfall",
                           static='05,0:51500910::', headless=True),
        ...
        SekiroLocationData("HF: Lump of Grave Wax - temple, miniboss drop", "Lump of Grave Wax",
                           static='05,0:51500900::', miniboss=True, drop=True),
    ...
    "Mibu Village": [
        ...
        SekiroLocationData("MV: Dragonspring Sake - Exiled Memorial Mob", "Dragonspring Sake",
                           static='05,0:-1:1500000:', npc=True, shop=True),
        ...
        SekiroLocationData("MV: Scrap Magnetite - downstream from Mibu Village idol, enemy drop", "Scrap Magnetite",
                           static='05,0:51500940::', drop=True),
        ...
        SekiroLocationData("MV: Treasure Carp Scale - kill Head Priest after Water of the Palace",
                           "Treasure Carp Scale x5", static='05,0:50006281::', conditional=True),
    ...
    "Ashina Castle - Interior Ministry": [
        ...
        SekiroLocationData("AC2: Yellow Gunpowder - Great Serpent Shrine, miniboss drop", "Yellow Gunpowder x2",
                           static='02,0:51110981::', missable=True),
    ...
    "Fountainhead Palace": [
        SekiroLocationData("FP: A Beast's Karma - beside Mibu Manor, miniboss drop", "A Beast's Karma",
        ...
        SekiroLocationData("FP: Ceramic Shard - past bridge, below platforms at water intersection", "Ceramic Shard x3",
                           static='08,0:52500270::'),
        SekiroLocationData("FP: Ceramic Shard - underwater, entrance to Great Carp ravine", "Ceramic Shard x2",
                           static='08,0:52500430::', conditional=True, diving=True),
        ...
        SekiroLocationData("FP: Divine Dragon's Tears - Sanctuary, boss drop", "Divine Dragon's Tears",
                           static='08,0:50002070::', prominent=True, progression=True, boss=True, conditional=True,
                           diving=True),
        SekiroLocationData("FP: Divine Grass - Feeding Attendant for Great White Whisker", "Divine Grass",
                           static='08,0:50006252::', missable=True, npc=True, conditional=True, diving=True),
        ...
        SekiroLocationData("FP: Dragon's Blood Droplet - left of Sanctuary idol", "Dragon's Blood Droplet",
                           static='08,0:52500540::', conditional=True, diving=True),
        SekiroLocationData("FP: Dragon's Blood Droplet - Pot Noble Koremori", "Dragon's Blood Droplet",
                           static='03,0:-1:1642,1000000,2500000:', npc=True, shop=True),
        ...
        SekiroLocationData("FP: Dragonspring Sake - before Great Sakura idol, enemy drop", "Dragonspring Sake",
                           static='08,0:52500950::', drop=True),
        SekiroLocationData("FP: Eel Liver - courtyard, behind bridge", "Eel Liver x2", static='08,0:52500060::'),
        SekiroLocationData("FP: Eel Liver - Mibu Manor, first house on left", "Eel Liver x3", static='08,0:52500150::'),
        ...
        SekiroLocationData("FP: Gokan's Sugar: past bridge, left-most high roof", "Gokan's Sugar x3",
                           static='08,0:52500973::'),
        SekiroLocationData("FP: Gourd Seed - Palace Grounds, chest", "Gourd Seed", static='08,0:6729::',
                           conditional=True, diving=True),
        SekiroLocationData("FP: Heavy Coin Purse - courtyard, middle between trees", "Heavy Coin Purse",
                           static='08,0:52500080::'),
        SekiroLocationData("FP: Heavy Coin Purse - Feeding Grounds, bridge", "Heavy Coin Purse",
                           static='08,0:52500550::', conditional=True, diving=True),
        SekiroLocationData("FP: Heavy Coin Purse - past bridge, giant tree base, left", "Heavy Coin Purse",
                           static='08,0:52500300::'),
        # Do not generate as we cannot guarantee which Bait is used
        #SekiroLocationData("FP: Lapis Lazuli - Koremori's pot after Truly Precious Bait", "Lapis Lazuli",
        #                   static='08,0:50006366::', missable=True, conditional=True, diving=True),
        ...
        SekiroLocationData("FP: Lump of Grave Wax - nearly submerged house roof in lake", "Lump of Grave Wax",
                           static='08,0:52500630::'),
        SekiroLocationData("FP: Lump of Grave Wax - underwater, building with Old Woman on roof", "Lump of Grave Wax",
                           static='08,0:52500610::', conditional=True, diving=True),
        SekiroLocationData("FP: Mask Fragment: Left - Pot Noble Koremori", "Mask Fragment: Left",
                           static='03,0:-1:1642,1000000,2500000:', npc=True, shop=True),
        SekiroLocationData("FP: Memory: Divine Dragon - Sanctuary, boss drop", "Memory: Divine Dragon",
                           static='08,0:50002071::', boss=True, conditional=True, diving=True),
        SekiroLocationData("FP: Memory: True Monk - Vermilion Bridge, boss drop", "Memory: True Monk",
        ...
        SekiroLocationData("FP: Mibu Balloon of Soul - Palace Grounds, pool of water", "Mibu Balloon of Soul x3",
                           static='08,0:52500530::', conditional=True, diving=True),
        ...
        SekiroLocationData("FP: Mibu Possession Balloon - by three enemies near waterfall miniboss #1",
                           "Mibu Possession Balloon", static='08,0:52500330::'),
        SekiroLocationData("FP: Mibu Possession Balloon - by three enemies near waterfall miniboss #2",
                           "Mibu Possession Balloon", static='08,0:52500340::'),
        SekiroLocationData("FP: Pellet - along the wall at first miniboss", "Pellet x2", static='08,0:52500240::'),
        SekiroLocationData("FP: Pellet - beginning of area behind collapsed strawman", "Pellet x2",
                           static='08,0:52500600::'),
        SekiroLocationData("FP: Pellet - Mibu Manor, central open area under tree", "Pellet", static='08,0:52500130::'),
        SekiroLocationData("FP: Pellet - past bridge, left before stairs to Palace Grounds", "Pellet x2",
                           static='08,0:52500350::'),
        SekiroLocationData("FP: Prayer Bead - Great Sakura, miniboss drop", "Prayer Bead", static='08,0:6784::',
                           miniboss=True),
        SekiroLocationData("FP: Prayer Bead - outside Mibu Manor, miniboss drop", "Prayer Bead", static='08,0:6783::',
                           miniboss=True),
        SekiroLocationData("FP: Prayer Bead - underwater, chest near giant fish skeleton", "Prayer Bead",
                           static='08,0:6797::', conditional=True, diving=True),
        SekiroLocationData("FP: Precious Bait - underwater, below Feeding Grounds", "Precious Bait",
                           static='08,0:52500410::', conditional=True, diving=True),
        SekiroLocationData("FP: Precious Bait - underwater, building beneath Great Sakura miniboss", "Precious Bait",
                           static='08,0:52500470::', conditional=True, diving=True),
        SekiroLocationData("FP: Precious Bait - underwater, log near headless", "Precious Bait",
                           static='08,0:52500500::', conditional=True, diving=True),
        SekiroLocationData("FP: Red Lump - underwater, right of demolished bridge", "Red Lump",
                           static='08,0:52500400::', conditional=True, diving=True),
        SekiroLocationData("FP: Scrap Magnetite - underwater, plants near Pot Noble Koremori", "Scrap Magnetite x3",
                           static='08,0:52500390::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - feed Great Carp once", "Treasure Carp Scale x3",
                           static='08,0:50006250::', npc=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - feed Great Carp twice", "Treasure Carp Scale",
                           static='08,0:50006251::', npc=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - Mibu Manor, dive in left corner before exit #1",
                           "Treasure Carp Scale", static='08,0:52500100::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - Mibu Manor, dive in left corner before exit #2",
                           "Treasure Carp Scale", static='08,0:52500120::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - Mibu Manor, dive in left corner before exit #3",
        ...
        SekiroLocationData("FP: Treasure Carp Scale - underwater, beneath Feeding Grounds, Carp drop",
                           "Treasure Carp Scale", static='08,0:52500974::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, further out from first bridge, Carp drop",
                           "Treasure Carp Scale", static='08,0:52500972::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, giant skeleton near headless #1",
                           "Treasure Carp Scale", static='08,0:52500480::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, giant skeleton near headless #2",
                           "Treasure Carp Scale", static='08,0:52500490::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, inside house along right wall #1",
                           "Treasure Carp Scale", static='08,0:52500440::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, inside house along right wall #2",
                           "Treasure Carp Scale", static='08,0:52500450::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, inside house along right wall #3",
                           "Treasure Carp Scale", static='08,0:52500460::', conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, middle of the lake, Carp drop", "Treasure Carp Scale",
                           static='08,0:52500978::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, near first bridge, Carp drop", "Treasure Carp Scale",
                           static='08,0:52500973::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, near first house of area, Carp drop",
                           "Treasure Carp Scale", static='08,0:52500976::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, right wall before building, Carp drop",
                           "Treasure Carp Scale", static='08,0:52500975::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Treasure Carp Scale - underwater, under Sakura Branch, Carp drop",
                           "Treasure Carp Scale", static='08,0:52500977::', drop=True, conditional=True, diving=True),
        SekiroLocationData("FP: Truly Precious Bait - Pot Noble Koremori after 9 scales",
                           "Truly Precious Bait (Koremori)", static='08,0:50006365::', missable=True, npc=True),
        SekiroLocationData("FP: Ungo's Sugar - courtyard, middle between trees", "Ungo's Sugar",
                           static='08,0:52500070::'),
        SekiroLocationData("FP: Ungo's Sugar - up the stairs from Feeding Grounds idol", "Ungo's Sugar x2",
                           static='08,0:52500680::', conditional=True, diving=True),
        ...
        SekiroLocationData("FP: Yashariku's Spiritfall - underwater, headless drop", "Yashariku's Spiritfall",
                           static='08,0:52500940::', conditional=True, headless=True, diving=True),
    ...
    "Ashina Castle - Central Forces": [
        ...
        SekiroLocationData("AC3: Bundled Jizo Statue - along path to Serpent Shrine, enemy drop", "Bundled Jizo Statue",
                           static='02,0:51110986::', drop=True),
        ...
        SekiroLocationData("AC3: Mibu Pilgrimage Balloon - complete Blackhat Badger quest", "Mibu Pilgrimage Balloon",
                           static='02,0:50006140::', missable=True, conditional=True),
    ...
    "Ashina Outskirts - Burning": [
        ...
        SekiroLocationData("AO2: Promissory Note - Anayama the Peddler", "Promissory Note", static='00,0:-1:1100300:',
                           missable=True, npc=True, shop=True, conditional=True),
    ],
    "Ashina Reservoir - Endgame": [
