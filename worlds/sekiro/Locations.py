...
location_tables: dict[str, list[SekiroLocationData]] = {
    ...
    "Ashina Outskirts": [
        ...
        SekiroLocationData("AO: Bundled Jizo Statue - ridge inner curve, wall cave", "Bundled Jizo Statue",
        ...
        SekiroLocationData("AO: Fistful of Ash - in Gyoubu arena", "Fistful of Ash x2", static="00,0:51100320::"),
        ...
        SekiroLocationData("AO: Gachiin's Sugar - ridge inner curve, tall grass", "Gachiin's Sugar x3",
    ...
    "Ashina Castle": [
        ...
        SekiroLocationData("AC: Ako's Sugar - before Bull arena, on left cliffside, behind wall", "Ako's Sugar x2",
        ...
        SekiroLocationData("AC: Black Gunpowder - outside building at ADG entrance", "Black Gunpowder",
                           static="02,0:51110300::"),
        SekiroLocationData("AC: Black Gunpowder - Tengu rat quest, enemy drop", "Black Gunpowder",
        ...
        SekiroLocationData("AC: Ceramic Shard - base of stairs after Ashina Castle Gate idol", "Ceramic Shard",
        ...
        SekiroLocationData("AC: Fistful of Ash - before Bull arena, corner house at tree", "Fistful of Ash x2",
        ...
        SekiroLocationData("AC: Gachiin's Sugar - at tree near Bull arena walls", "Gachiin's Sugar x2",
        ...
        SekiroLocationData("AC: Gatehouse Key - bridge leading to ADG, enemy drop", "Gatehouse Key",
        ...
        SekiroLocationData("AC: Light Coin Purse - left before bridge to ADG in house", "Light Coin Purse",
        ...
        SekiroLocationData("AC: Light Coin Purse - top level of building near stairs to Bull arena",
        ...
        SekiroLocationData("AC: Pellet - tree near Tengu rat quest enemy", "Pellet x2",
        ...
        SekiroLocationData("AC: Prayer Bead - Ashina Castle Gate, miniboss drop", "Prayer Bead", static="02,0:6765::",
                           miniboss=True),
        ...
        SekiroLocationData("AC: Scrap Iron - before Bull arena, hidden behind corner house", "Scrap Iron",
        ...
        SekiroLocationData("AC: Scrap Iron - on stone near Bull arena walls", "Scrap Iron", static="02,0:51110830::"),
        ...
        SekiroLocationData("AC: Scrap Magnetite - before Bull arena, enemy drop", "Scrap Magnetite",
        ...
        SekiroLocationData("AC: Shinobi Medicine Rank 2 - Ashina Castle Gate, miniboss drop",
    ...
    "Abandoned Dungeon": [
        ...
        SekiroLocationData("AD: Bite Down - thin cave connecting ADG to Bottomless Hole", "Bite Down",
    ...
    "Ashina Castle (Interior Ministry)": [
        ...
        SekiroLocationData("AC/I: Pellet - at end of bridge from ADG", "Pellet x2", static="02,0:51110040::"),
        SekiroLocationData("AC/I: Pellet - balcony at Isshin's watchtower", "Pellet", static="02,0:51110870::"),
        SekiroLocationData("AC/I: Pellet - corpse on rooftop path, overlooking Gyoubu's arena", "Pellet x2",
