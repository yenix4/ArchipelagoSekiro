...
location_tables: Dict[str, List[SekiroLocationData]] = {
    ...
    "Senpou Temple, Mt. Kongo": [
        ...
        SekiroLocationData("ST: Antidote Powder - cliffside right of cricket building #2, 3-item group", "Antidote Powder",
    ...
    "Ashina Castle - Interior Ministry": [
        ...
        SekiroLocationData("AC2: Divine Grass - Kuro after entering Fountainhead Palace", "Divine Grass", missable=True,
                           npc=True, conditional=True),
        ...
        # boss=True),
        # SekiroLocationData("AC2: One Mind - Upper Tower roof, Shura boss drop", "One Mind", boss=True),
    ],
    "Hirata Estate - Father's Bell Charm": [
