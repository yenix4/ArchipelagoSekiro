...
location_tables: dict[str, list[SekiroLocationData]] = {
    ...
    "Ashina Outskirts": [
        ...
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Pellet - left on lower path at area start", "Pellet", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ungo's Sugar - broken wall above Ashina Outskirts idol", "Ungo's Sugar", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ceramic Shard - under branch on lower path at area start", "Ceramic Shard",
                           missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ungo's Sugar - gate house before tall grass", "Ungo's Sugar x2", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ceramic Shard - right cliff from Outskirts idol, near broken wall", "Ceramic Shard x2",
                           missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Fistful of Ash - cliff courtyard, broken hut", "Fistful of Ash x2", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Pellet - left above wide gate house", "Pellet x3", missable=True),
        ...
        SekiroLocationData("AO: Pellet - just before Underbridge Valley idol", "Pellet x2"),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ungo's Sugar - fortress, behind house", "Ungo's Sugar", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Heavy Coin Purse - fortress, courtyard house bottom floor", "Heavy Coin Purse",
                           missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Fistful of Ash - fortress, near dead horse", "Fistful of Ash x2", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Pellet - fortress, near doors opened from other side", "Pellet x2", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ako's Sugar - fortress, along left outer wall from idol", "Ako's Sugar", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Fistful of Ash - boss arena", "Fistful of Ash x2", missable=True),
        ...
        SekiroLocationData("AO: Pellet - behind cliffside gate", "Pellet x2"),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ako's Sugar - right cliff from Outskirts idol, wall cave", "Ako's Sugar", hidden=True,
                           missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Pellet - left of gate to Gate Path idol", "Pellet", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ceramic Shard - left of Gate Path idol", "Ceramic Shard x2", missable=True),
        ...
        # Removed in the second invasion, therefore not missable in Shura
        SekiroLocationData("AO: Ceramic Shard - fortress, courtyard outside house", "Ceramic Shard", missable=True),
        # Removed in the second invasion, therefore not missable in Shura
        ...
        SekiroLocationData("AO: Pellet - tree near Tengu rat quest enemy", "Pellet x2", missable=True),
        # Generally missable after the first invasion (unless skip, but we do not assume that)
    ...
    "Hirata Estate (Young Lord's Bell Charm)": [
        ...
        SekiroLocationData("HE1: Fistful of Ash - tree near bonfire", "Fistful of Ash"),
    ...
    "Ashina Reservoir": [
        ...
        SekiroLocationData("AR: Heavy Coin Purse - gatehouse, next to chest", "Heavy Coin Purse", conditional=True,
                           missable=True),
    ...
    "Senpou Temple, Mt. Kongo": [
        ...
        SekiroLocationData("ST: Pellet - broken bridge, other side", "Pellet"),
        ...
        SekiroLocationData("ST: Pellet - path to cricket building", "Pellet"),
        SekiroLocationData("ST: Light Coin Purse - roof of mini gate at area start", "Light Coin Purse", hidden=True),
    ...
    "Mibu Village": [
        ...
        SekiroLocationData("MV: Pellet - dried riverbank left of big tree", "Pellet x3"),
        ...
        SekiroLocationData("MV: Light Coin Purse - hut across from Head Priest's house in bird's nest",
                           "Light Coin Purse"),
        SekiroLocationData("MV: Pellet - boat across pond", "Pellet"),
