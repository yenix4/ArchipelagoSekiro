...
_all_items = [
    ...
    *SekiroItemData("Mibu Balloon of Spirit", 0xe2e, SekiroItemCategory.MISC, filler = True).counts([2, 3]),
    ...
    SekiroItemData("Shinobi Medicine Rank 1", 0x9a6, SekiroItemCategory.SKILLS,
                   classification = ItemClassification.useful),
    SekiroItemData("Floating Passage Text", 0x9a7, SekiroItemCategory.SKILLS),
    SekiroItemData("Shinobi Medicine Rank 2", 0x9a7, SekiroItemCategory.SKILLS,
                   classification = ItemClassification.useful),
    # For now injected as unreachable in regular ending.
    # redo when implementing alternate ending for Shura
    SekiroItemData("One Mind", 0x9a8, SekiroItemCategory.SKILLS, inject = True),
    ...
    SekiroItemData("Truly Precious Bait", 0x23dd, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression),
    SekiroItemData("Truly Precious Bait", 0x23de, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression),
    ...
    SekiroItemData("Holy Chapter: Infested", 0x2400, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression),
    SekiroItemData("Tomoe's Note", 0x2401, SekiroItemCategory.UNIQUE),
    SekiroItemData("Flame Barrel Memo", 0x2402, SekiroItemCategory.UNIQUE),
    SekiroItemData("Nightjar Beacon Memo", 0x2403, SekiroItemCategory.UNIQUE),
    SekiroItemData("Isshin's Letter", 0x2404, SekiroItemCategory.UNIQUE),
    SekiroItemData("Rotting Prisoner's Note", 0x2405, SekiroItemCategory.UNIQUE),
    SekiroItemData("Sabimaru Memo", 0x2406, SekiroItemCategory.UNIQUE),
    SekiroItemData("Valley Apparitions Memo", 0x2408, SekiroItemCategory.UNIQUE),
    SekiroItemData("Three-story Pagoda Memo", 0x240a, SekiroItemCategory.UNIQUE),
    ...
    SekiroItemData("Black Scroll", 0x240c, SekiroItemCategory.UNIQUE),
