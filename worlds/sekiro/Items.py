...
_all_items = [
    ...
    *SekiroItemData("Red Lump", 0x40000BEA, SekiroItemCategory.MISC).counts([2]),
    ...
    SekiroItemData("Persimmon", 0x40000BFE, SekiroItemCategory.MISC,
                   classification = ItemClassification.progression_deprioritized),
    SekiroItemData("Rice", 0x40000C08, SekiroItemCategory.MISC,
                   classification = ItemClassification.progression_deprioritized),
    ...
    *SekiroItemData("Mibu Balloon of Spirit", 0x40000E2E, SekiroItemCategory.MISC, filler = True).counts([2, 3]),
    ...
    # Weapon ID for Mibu: 0x000A6040, this may need changing in the static rando down the line
    # as it sometimes errors with either ID used (especially in shops).
    ...
    SekiroItemData("Five-color Rice", 0x40000DFC, SekiroItemCategory.UNIQUE, skip = True),
    ...
    SekiroItemData("Red and White Pinwheel", 0x40002378, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression_deprioritized),
    SekiroItemData("White Pinwheel", 0x40002379, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression_deprioritized),
...
_added_region_locks = [
    ...
    SekiroItemData("Senpou Temple Key", 0x400024BE, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression),
    SekiroItemData("Bell of Dispelling", 0x400024C1, SekiroItemCategory.UNIQUE,
                   classification=ItemClassification.progression),
    SekiroItemData("Ashina Depths Key", 0x400024C0, SekiroItemCategory.UNIQUE,
                   classification = ItemClassification.progression),
    SekiroItemData("Ashina Requisitions Whistle", 0x400024C2, SekiroItemCategory.UNIQUE,
                   classification=ItemClassification.progression),
]
