...
[Game Page]: /games/Sekiro:%Shadows%Die%Twice/info/en
[Locations]: /tutorial/Sekiro:%Shadows%Die%Twice/locations/en

## Item Groups

The Sekiro: Shadows Die Twice randomizer supports a number of item group names, which can
